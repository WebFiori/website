...
class WebFioriTheme extends Theme{
    public function __construct() {
        ...
        $this->setAfterLoaded(function(){
            ...
            $item1 = new ListItem();
            $link1 = new Anchor(SiteConfig::getBaseURL().'download', $translation->get('menus/main-menu/menu-item-1'));
            $item1->addChild($link1);
            $mainMenu->addChild($item1);

            $item2 = new ListItem();
            $link2 = new Anchor(SiteConfig::getBaseURL().'docs/webfiori', $translation->get('menus/main-menu/menu-item-2'));
            $item2->addChild($link2);
            $mainMenu->addChild($item2);

            $item3 = new ListItem();
            $link3 = new Anchor(SiteConfig::getBaseURL().'learn', $translation->get('menus/main-menu/menu-item-3'));
            $item3->addChild($link3);
            $mainMenu->addChild($item3);
            
            $item4 = new ListItem();
            $link4 = new Anchor(SiteConfig::getBaseURL().'contribute', $translation->get('menus/main-menu/menu-item-4'));

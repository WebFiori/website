...
class RunSQLQueryCommandView extends P {
    public function __construct(){
        ...
        $this->insert($this->getTheme()->createClassDescriptionNode('class', 'RunSQLQueryCommand', '\webfiori\framework\cli', 'A command which can be used to execute SQL queries on   specific database. '));
        $classAttrsArr = [
        ];
        $classMethodsArr = [
            new FunctionDef([

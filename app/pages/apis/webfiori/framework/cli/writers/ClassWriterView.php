...
class ClassWriterView extends P {
    public function __construct(){
        ...
        $this->insert($this->getTheme()->createClassDescriptionNode('class', 'ClassWriter', '\webfiori\framework\cli\writers', 'A utility class which is used as a helper class with the command \'create\'. This class can be used to write .php classes.'));
        $classAttrsArr = [
        ];
        $classMethodsArr = [
            new FunctionDef([

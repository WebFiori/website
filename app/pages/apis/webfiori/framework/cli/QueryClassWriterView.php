...
class QueryClassWriterView extends P {
    public function __construct(){
        ...
        $this->insert($this->getTheme()->createClassDescriptionNode('class', 'QueryClassWriter', '\webfiori\framework\cli', 'A class which is used to write query class from an instance of the class   \'MySQLQuery\'. This class is used to write new query class based on a temporary   query object. It is used as a helper class if the command \'create\' is executed   from CLI and the option \'Query class\' is selected.'));
        $classAttrsArr = [
        ];
        $classMethodsArr = [
            new FunctionDef([

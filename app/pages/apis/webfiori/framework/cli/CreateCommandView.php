...
class CreateCommandView extends P {
    public function __construct(){
        ...
        $this->insert($this->getTheme()->createClassDescriptionNode('class', 'CreateCommand', '\webfiori\framework\cli', 'A command which is used to automate some of the common tasks such as   creating table classes or controllers. Note that this feature is Experimental and might have issues. Also, it   might be removed in the future.'));
        $classAttrsArr = [
        ];
        $classMethodsArr = [
            new FunctionDef([

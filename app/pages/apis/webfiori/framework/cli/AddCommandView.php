...
class AddCommandView extends P {
    public function __construct(){
        ...
        $this->insert($this->getTheme()->createClassDescriptionNode('class', 'AddCommand', '\webfiori\framework\cli', 'A command which is used to add a database connection or SMTP account. '));
        $classAttrsArr = [
        ];
        $classMethodsArr = [
            new FunctionDef([

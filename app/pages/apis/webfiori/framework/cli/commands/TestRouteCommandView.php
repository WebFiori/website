...
class TestRouteCommandView extends P {
    public function __construct(){
        ...
        $this->insert($this->getTheme()->createClassDescriptionNode('class', 'TestRouteCommand', '\webfiori\framework\cli\commands', 'A CLI Command which is used to test the result of routing to a specific   route. '));
        $classAttrsArr = [
        ];
        $classMethodsArr = [
            new FunctionDef([

...
class ListThemesCommandView extends P {
    public function __construct(){
        ...
        $this->insert($this->getTheme()->createClassDescriptionNode('class', 'ListThemesCommand', '\webfiori\framework\cli\commands', 'A CLI command which is used to list all registered themes. '));
        $classAttrsArr = [
        ];
        $classMethodsArr = [
            new FunctionDef([

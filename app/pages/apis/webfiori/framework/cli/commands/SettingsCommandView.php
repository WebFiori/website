...
class SettingsCommandView extends P {
    public function __construct(){
        ...
        $this->insert($this->getTheme()->createClassDescriptionNode('class', 'SettingsCommand', '\webfiori\framework\cli\commands', 'A CLI command which is used to show framework configuration. '));
        $classAttrsArr = [
        ];
        $classMethodsArr = [
            new FunctionDef([

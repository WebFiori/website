...
class ListRoutesCommandView extends P {
    public function __construct(){
        ...
        $this->insert($this->getTheme()->createClassDescriptionNode('class', 'ListRoutesCommand', '\webfiori\framework\cli', 'A CLI command which is used to show a list of all added routes. '));
        $classAttrsArr = [
        ];
        $classMethodsArr = [
            new FunctionDef([

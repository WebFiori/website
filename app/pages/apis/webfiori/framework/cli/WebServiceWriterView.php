...
class WebServiceWriterView extends P {
    public function __construct(){
        ...
        $this->insert($this->getTheme()->createClassDescriptionNode('class', 'WebServiceWriter', '\webfiori\framework\cli', 'A writer class which is used to create new web service class. '));
        $classAttrsArr = [
        ];
        $classMethodsArr = [
            new FunctionDef([

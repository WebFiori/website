...
class CronCommandView extends P {
    public function __construct(){
        ...
        $this->insert($this->getTheme()->createClassDescriptionNode('class', 'CronCommand', '\webfiori\framework\cli', 'A CLI command which is related to executing   background jobs or performing operations on them. .'));
        $classAttrsArr = [
        ];
        $classMethodsArr = [
            new FunctionDef([

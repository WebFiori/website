...
Page::render();');
        ...
        $sec2->addChild($this->createParagraph('Now we are done with the '
                ...
                . 'to add a route to the view that we have just created.'
                . ''));
        $code6 = new CodeSnippet();
        $code6->setTitle('PHP Code');
        $code6->setCode(str_replace('<', '&lt;', str_replace('>', '&gt;', ''
                . '<?php namespace webfiori\entity\router;
if(!defined(\'ROOT_DIR\')){
...
<html>
    <head>
        <base href="http://localhost/webfiori-website/">
        <title>
            Welcome to My WebSite | My Personal Blog
        </title>
        <link rel="canonical" href="http://localhost/webfiori-website/home">
